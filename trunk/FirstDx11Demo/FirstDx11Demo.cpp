// FirstDx11Demo.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "FirstDx11Demo.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_FIRSTDX11DEMO, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_FIRSTDX11DEMO));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_FIRSTDX11DEMO);
